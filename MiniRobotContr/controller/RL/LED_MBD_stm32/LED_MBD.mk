...
#                        of executable (1/0)?
MODEL                = LED_MBD
MODULES              = LED_MBD_TIM.c LED_MBD_data.c main.c stm32xxxx_it.c rtiostream_utils.c
MODULES_OBJ          = LED_MBD_TIM.obj LED_MBD_data.obj main.obj stm32xxxx_it.obj rtiostream_utils.obj 
MAKEFILE             = LED_MBD.mk
TOOLPATH             = "|>COMPILERPATH<|"
MATLAB_ROOT          = "D:/Program Files/MATLAB/R2023a"
ALT_MATLAB_ROOT      = "D:/PROGRA~2/MATLAB/R2023a"
MATLAB_BIN           = "D:/Program Files/MATLAB/R2023a/bin"
ALT_MATLAB_BIN       = "D:/PROGRA~2/MATLAB/R2023a/bin"
S_FUNCTIONS_LIB      = 
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = LED_MBD_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IE:/DR_Han/小人形关节整合/controller/RL  -IE:/DR_Han/小人形关节整合/controller/RL/LED_MBD_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src  -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils  -ID:/MATLAB/STM32-MAT/STM32/addSrc/inc 
